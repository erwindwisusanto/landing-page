<footer class="footer">
    ...
    <div class="container overflow-hidden px-4">
      <div class="row gy-4 gy-lg-0 justify-content-xl-between">
        <div class="col-6 col-md-4 col-lg-3 col-xl-2 d-flex align-items-center">
          <div class="widget">
            <a href="#!">
              <img src="{{ asset('assets/img/logo-white-cepat-sehat.svg') }}" alt="cepat sehat">
            </a>
          </div>
        </div>
				<div class="col-6 col-md-4 col-lg-3 col-xl-2 d-flex justify-conten-end align-items-center">
          <div class="widget" style="text-align: right;">
						<div class="row">
							<span class="txt-white" style="font-size: 13px;">
								Member of Aliansi Telemedik Indonesia
							</span>
						</div>
						<div class="row">
							<a clas href="https://atensi.or.id/">
								<img src="{{ asset('assets/img/logo-atensi.svg') }}" alt="cepat sehat">
						</div>
            </a>
          </div>
        </div>
        <div class="col-12 col-md-4 col-lg-3 col-xl-2 pt-4">
          <div class="widget">
            ...
            <p class="mb-1">
              <a class="txt-white text-decoration-none" href="tel:+62822 1118 9009" style="font-weight: 500;">
          ...
          <ul class="nav justify-content-center justify-content-md-end">
            <li class="nav-item">
              <a class="nav-link txt-white" href="#!">
  ...
  <div class="bg-white py-2 py-md-5 py-xl-8 border-top border-light-subtle">
    <div class="container overflow-hidden">
      <div class="row gy-4 gy-md-0">
        <div class="col-xs-12 col-md-7 order-1 order-md-0">
          <div class="copyright text-center text-md-start" style="font-size: 12px;">
            Copyright &copy; {{ date('Y') }} Cepat Sehat. All Rights Reserved.
          </div>
        </div>
      </div>
    </div>
