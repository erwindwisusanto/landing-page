...
<body>
	...
	<div class="content">
		<section class="banner-pages page face-cream">
			<div class="container">
				<div class="text">
					<h3 class="text-primary">
						Face Cream Botani <span class="text-dark"> untuk
							Kelembapan Tahan Lama </span>
					</h3>
					<p class="desc">
						Dapatkan kulit yang halus dan lembap sepanjang hari dengan Face Cream kami. Formula ringan yang
						kaya akan bahan botani membuatnya sempurna untuk menjaga kelembapan kulit wajah Anda.
					</p>
				</div>
			</div>
							...
							<div class="col-7">
								<div class="detail bg-soft">
									...
									<ul>
										...
										<li>
											Membuat kulit sehat serta tampak lebih cerah
										</li>
									</ul>
									<p>
										<b>Komposisi :</b> SPF, Niacin, Tranex, Arbutin, Glutation, Butylene Glycol,
										Saphora Root Extrak, Saururus, Chinensis, Licorice.
									</p>
						...
						<div class="card-product row align-content-stretch g-0">
							<div class="col-7">
								<div class="detail bg-soft-mobile">
									...
									<p>
										<b>Komposisi :</b> Sleeping Mask, Niacin, Tranex, Arbutin, Glutation, Citric
										Acid, Butylene Glycol, Saphora Root Extrak, Saururus Chinensis, Licorice
									</p>
									<a href="#book" class="btn btn-whatsapp w-100 px-2 fs-14">
										<i class="mdi mdi-whatsapp me-2"></i> Pesan Sekarang
									</a>
						...
						<div class="card-product row align-content-stretch g-0">
							<div class="col-7">
								<div class="detail bg-soft">
									...
									<p>
										<b>Komposisi :</b> Collagen, Glutahione, Vitis Vinifera Seed Extract, Lecithin,
										Linoleic Acid, Linolenic acid, Tocopheryl, Sodium ascorbyl phosphate,
										Tocopherol, Centella asiatica extract, Arbutin, etc
									</p>
									<a href="#book" class="btn btn-whatsapp w-100 px-2 fs-14">
										<i class="mdi mdi-whatsapp me-2"></i> Pesan Sekarang
									</a>
						...
						<div class="card-product row align-content-stretch g-0">
							<div class="col-7">
								<div class="detail bg-soft-mobile">
									...
									<p>
										<b>Komposisi :</b> Niacinamide, Aloe Barbadensis Extract, Hamamelis Virginiana,
										Allantoin, Glutathione, etc
									</p>
									<a href="#book" class="btn btn-whatsapp w-100 px-2 fs-14">
										<i class="mdi mdi-whatsapp me-2"></i> Pesan Sekarang
									</a>
							...
							<div class="col-7">
								<div class="detail bg-soft">
									...
									<ul>
										...
										<li>
											Meredakan sunburn setelah beraktifitas di luar ruangan
										</li>
										<li>
											Mengurangi kemerahan di kulit & membantu sebagai soothing agent di kulit
										</li>
									</ul>
									<p>
										<b>Komposisi :</b> SPF, Centella asiatica extract, Cucumis sativus extract,
										Artemisia vulgaris extract, Ribes nigrum seed oil, Halianthus annuus
										seed oil unsaponifiables, Cardiospermum halicacabum seed extract, Tocopherol,
										Rosmarinus Officinalis (Rosemary) Leaf
										Extract, Aloe Barbadensis Extract, etc.
									</p>
									<a href="#book" class="btn btn-whatsapp w-100 px-2 fs-14">
										<i class="mdi mdi-whatsapp me-2"></i> Pesan Sekarang
									</a>
	...
	<div class="btn-float" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Consult with Our Medical Team"
		...
		<div class="btn-circle whatsapp">
			<a href="https://api.whatsapp.com/send/?phone=6285212500030&text=Hello+Ercellskin.com%2C+I+want+a+consultation+or+buy...&type=phone_number&app_absent=0"
				class="text-white">
