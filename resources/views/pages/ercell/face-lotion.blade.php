...
<body>
	...
	<div class="content">
		<section class="banner-pages page face-lotion">
			<div class="container">
				<div class="text">
					<h3 class="text-primary">
						Face Lotion Botani <span class="text-dark"> untuk Kulit yang Sehat </span>
					</h3>
					<p class="desc">
						Face Lotion kami memberikan kelembapan optimal dan nutrisi yang dibutuhkan kulit Anda. Rasakan
						...
						<div class="card-product row align-content-stretch g-0">
							<div class="col-7">
								<div class="detail bg-soft">
									...
									<p>
										<b>Komposisi :</b> Sulfuric acid, Rode extract, Salicylic acid, etc
									</p>
							...
							<div class="col-5">
								<div class="image">
									<div class="text-center">
										<img src="{{ asset('assets/ercell/assets/img/product/product-facelotion.png') }}" alt="" class="img-product">
									</div>
									<div class="d-flex align-items-end justify-content-between">
										<img src="{{ asset('assets/ercell/assets/img/product/Acne Lotion_20 ml.png') }}" class="code" alt="">
										<span class="status">
											20 ml
										</span>
									</div>
