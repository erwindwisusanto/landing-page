...
<body>
                    ...
                    <div class="row mb-3 g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select form-control" id="service" aria-label="Default select example">
															<option selected>{{ __('landing.dropdown.option1') }}</option>
															<option selected>{{ __('landing.dropdown.option2') }}</option>
															<option selected>{{ __('landing.dropdown.option3') }}</option>
                            </select>
                        </div>
                    </div>
    ...
    <footer class="footer">
			...
			<div class="footer-bottom">
				Copyright © {{ date('Y') }} Cepat Sehat. All Rights Reserved.
			</div>
		</footer>
